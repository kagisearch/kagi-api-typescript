...
export class SearchRequestPersonalizationsDomainsInner {
    /**
    ...
    */
    'kind': SearchRequestPersonalizationsDomainsInnerKindEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "kind",
            "baseName": "kind",
            "type": "SearchRequestPersonalizationsDomainsInnerKindEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return SearchRequestPersonalizationsDomainsInner.attributeTypeMap;
    }
...
export enum SearchRequestPersonalizationsDomainsInnerKindEnum {
    Block = 'block',
    Lower = 'lower',
    Raise = 'raise',
    Pin = 'pin'
