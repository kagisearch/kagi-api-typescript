...
export class TranslateWordInsights200Response {
    /**
    * The translated text with markers (<<INSIGHT_N>>) indicating insight locations
    */
    'markedTranslation'?: string;
    'insights'?: Array<TranslateWordInsights200ResponseInsightsInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "markedTranslation",
            "baseName": "marked_translation",
            "type": "string",
            "format": ""
        },
        {
            "name": "insights",
            "baseName": "insights",
            "type": "Array<TranslateWordInsights200ResponseInsightsInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return TranslateWordInsights200Response.attributeTypeMap;
    }
