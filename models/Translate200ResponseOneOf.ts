...
export class Translate200ResponseOneOf {
    /**
    * Translated text
    */
    'translation'?: string;
    'detectedLanguage'?: Translate200ResponseOneOfDetectedLanguage;
    'definition'?: Translate200ResponseOneOfDefinition;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "detectedLanguage",
            "type": "Translate200ResponseOneOfDetectedLanguage",
            "format": ""
        },
        {
            "name": "definition",
            "baseName": "definition",
            "type": "Translate200ResponseOneOfDefinition",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return Translate200ResponseOneOf.attributeTypeMap;
    }
