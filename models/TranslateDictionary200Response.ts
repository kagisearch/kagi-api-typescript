...
export class TranslateDictionary200Response {
    'definition'?: TranslateDictionary200ResponseDefinition;
    'language'?: TranslateDictionary200ResponseLanguage;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "definition",
            "baseName": "definition",
            "type": "TranslateDictionary200ResponseDefinition",
            "format": ""
        },
        {
            "name": "language",
            "baseName": "language",
            "type": "TranslateDictionary200ResponseLanguage",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return TranslateDictionary200Response.attributeTypeMap;
    }
