...
export class TranslateAlternatives200Response {
    /**
    * A short description of the style, formality, or key characteristics of the text
    */
    'originalDescription'?: string;
    'elements'?: Array<TranslateAlternatives200ResponseElementsInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "elements",
            "baseName": "elements",
            "type": "Array<TranslateAlternatives200ResponseElementsInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return TranslateAlternatives200Response.attributeTypeMap;
    }
