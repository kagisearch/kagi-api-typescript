...
export class Translate200ResponseOneOfDefinitionDefinitionsInner {
    /**
    * Part of speech
    */
    'partOfSpeech'?: string;
    'meanings'?: Array<Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "meanings",
            "baseName": "meanings",
            "type": "Array<Translate200ResponseOneOfDefinitionDefinitionsInnerMeaningsInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return Translate200ResponseOneOfDefinitionDefinitionsInner.attributeTypeMap;
    }
