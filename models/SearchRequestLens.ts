 ...
 *
 * OpenAPI spec version: v1 (Preview)
...
export class SearchRequestLens {
    ...
    */
    'timeRelative'?: SearchRequestLensTimeRelativeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "sitesIncluded",
            "baseName": "sites_included",
            "type": "Array<string>",
            "format": ""
        },
        {
            "name": "sitesExcluded",
            "baseName": "sites_excluded",
            "type": "Array<string>",
            "format": ""
        },
        {
            "name": "keywordsIncluded",
            "baseName": "keywords_included",
            "type": "Array<string>",
            "format": ""
        },
        {
            "name": "keywordsExcluded",
            "baseName": "keywords_excluded",
            "type": "Array<string>",
            "format": ""
        },
        {
        ...
        {
            "name": "timeRelative",
            "baseName": "time_relative",
            "type": "SearchRequestLensTimeRelativeEnum",
            "format": ""
        },
        {
            "name": "searchRegion",
            "baseName": "search_region",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return SearchRequestLens.attributeTypeMap;
    }
...
export enum SearchRequestLensTimeRelativeEnum {
    Day = 'day',
    Week = 'week',
    Month = 'month'
}
