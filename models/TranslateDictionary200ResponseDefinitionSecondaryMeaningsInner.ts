...
export class TranslateDictionary200ResponseDefinitionSecondaryMeaningsInner {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "partOfSpeech",
            "baseName": "part_of_speech",
            "type": "Array<string>",
            "format": ""
        },
        {
            "name": "usageLevel",
            "baseName": "usage_level",
            "type": "Array<string>",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return TranslateDictionary200ResponseDefinitionSecondaryMeaningsInner.attributeTypeMap;
    }
