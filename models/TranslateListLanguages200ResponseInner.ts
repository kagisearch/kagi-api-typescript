...
export class TranslateListLanguages200ResponseInner {
    /**
    * Language code
    */
    'language'?: string;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "supportsFormality",
            "baseName": "supports_formality",
            "type": "boolean",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return TranslateListLanguages200ResponseInner.attributeTypeMap;
    }
