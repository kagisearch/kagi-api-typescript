...
*/
export class Translate200ResponseOneOfDefinition {
    /**
    ...
    */
    'phonetic'?: string;
    'definitions'?: Array<Translate200ResponseOneOfDefinitionDefinitionsInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<Translate200ResponseOneOfDefinitionDefinitionsInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return Translate200ResponseOneOfDefinition.attributeTypeMap;
    }
