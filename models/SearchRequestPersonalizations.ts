...
*/
export class SearchRequestPersonalizations {
    /**
    ...
    */
    'domains'?: Array<SearchRequestPersonalizationsDomainsInner>;
    /**
    * Regex-based personalization rules (maximum 1000 rules, max 1000 bytes per pattern).
    */
    'regexes'?: Array<SearchRequestPersonalizationsRegexesInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "domains",
            "baseName": "domains",
            "type": "Array<SearchRequestPersonalizationsDomainsInner>",
            "format": ""
        },
        {
            "name": "regexes",
            "baseName": "regexes",
            "type": "Array<SearchRequestPersonalizationsRegexesInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return SearchRequestPersonalizations.attributeTypeMap;
    }
